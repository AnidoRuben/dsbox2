...
public class DSBOXConfig {
    ...
    public DSBOXConfig(String dsboxHomeDir, DSBOXXMLDAO dao) {
    ...
    private void copyDefaultImage(File imagesDir) throws DSBOXException {
        ...
        try {
            ...
            throw new DSBOXException("Error creating default VM image at " + imageFilename, ex);
        }
    }
    ...
    private void createDefaultHostType() throws DSBOXException {
        ...
        VMImage defaultVMImage = new VMImage(VMImage.ImageType.VDI, defaultImageFile.getAbsolutePath(), defaultImageFile.getAbsolutePath());
