...
//    private CheckBox useCommonSharedFolder;
  ...
  //      addPropertyControl(grid, 12, "Services autoconfig :", servicesAutostartSupported);
        ...
        addPropertyControl(grid, 20, "Compressor :", vmImage_compressorType);

        grid.add(new Separator(Orientation.HORIZONTAL), 0, 21, 2, 1);
